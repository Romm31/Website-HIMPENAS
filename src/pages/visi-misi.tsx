  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-100">
      ...
      <main className="flex-grow">
        ...
        <section
          ref={contentRef}
          className={`bg-white py-24 fade-in-section ${contentInView ? 'is-visible' : ''}`}
        >
                  ...
                  <ul className="space-y-4">
                    {misiItems.map((item) => (
                      ...
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-6 w-6 mr-3 text-emerald-himp flex-shrink-0 mt-1 transition-transform duration-500 group-hover:scale-125"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
