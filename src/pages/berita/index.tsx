      ...
      >
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto">
            Temukan cerita, inovasi, dan aksi terbaru dari Himpunan Mahasiswa
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
            {berita.length > 0 ? (
              berita.map((item) => (
                <div
                  key={item.id}
                  className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden h-full flex flex-col card-hover-effect"
                >
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <p className="text-gray-600 text-sm mb-4 line-clamp-3">
                      {item.konten || 'Tidak ada deskripsi.'}
                    </p>
                    <Link
                      href={`/berita/${item.id}`}
                      className="font-semibold text-emerald-himp mt-auto flex items-center group"
                    >
                      Baca Selengkapnya
                      <svg
